...
\raisebox{-.075cm}{\href{http://gitlab.ithaca.fr/University/dsge-bayesian-estimation-sc.git}{\includegraphics[scale=.1]{../img/gitlab.png}}}
}\hspace{1cm}}
...
\begin{frame}
  ...
  \begin{center}
  \scalebox{.7}{\input{../img/mhplot-a.tex}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
  \scalebox{.7}{\input{../img/mhplot-b.tex}}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
  \scalebox{.7}{\input{../img/mhplot-c.tex}}
  \end{center}
\end{frame}
